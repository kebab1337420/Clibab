    ...
    resolve(specifier, context, nextResolve) {
        if (context.parentURL?.endsWith("/recorder.ts")) {
            const stubs = {
                ...
                "./utils": "export const captureFrameRate = () => 30; export const captureHeight = () => 0; export const captureVideoBitrate = () => 8_000_000; export const clipRetentionSeconds = () => 30; export const errorMessage = e => String(e); export const formatBytes = () => '0'; export const isLinux = () => false; export const TIMESLICE = 1000; export const timestampName = () => 'clip';",
